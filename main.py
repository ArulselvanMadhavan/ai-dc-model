...
h100_specs = XpuSpecs((989000, 0.22), (3350, 0.7), (80, 0.85), "H100")
...
opt175b = ModelSpecs(12*11*8, 2048, 12288, 4*12288, 50272, 96, True, False, None,
...
llama8b_text = ModelSpecs(16*128, 8192, 4096, 3.5*4096, 128256, 32, True, False,
                          None, Dtypes.FP16, 8, 32, True, "llama8B", 930000)
