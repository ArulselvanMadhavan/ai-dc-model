...
if __name__ == "__main__":
    ...
    llama_vit = ModelSpecs(32, 1, 1280, 4*1280, 128256, 40, True, False, VisionSpecs(224, 224, 14, 3), Dtypes.FP16, 1, 1)
    llama_text = ModelSpecs(32, 256, 8192, 3.5*8192, 128256, 80, True, True, None, Dtypes.FP16, 8, 64)
